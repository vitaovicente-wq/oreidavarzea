    ...
    enviarBoasVindas: function(game) {
        ...
        if (div === 'serieA') {
            if (forcaMedia >= 80) {
                ...
                tom.elenco = `⭐ <b>Liderança:</b> <b>${craque.nome}</b> é a referência técnica. O time deve jogar por ele, mas cobre intensidade.`;
                ...
                tom.intro = "Temos camisa e história, mas precisamos de regularidade. O clube viveu anos de oscilação e queremos estabilidade.";
                tom.meta = "🌎 <b>Meta Realista:</b> Vaga na Sul-Americana (Top 12). Sonhar alto é permitido, mas não perca o foco.";
        ...
        const html = `
            <div class="email-container" style="font-family:'Georgia', serif; line-height:1.6; color:#ddd;">
                ...
                <p>${tom.aviso}</p>
                <p>O Diretor Comercial apresentará as propostas de patrocínio a seguir. Escolha com sabedoria.</p>
            ...
            <div style="background:#222; padding:15px; border-left:4px solid #fff; display:grid; grid-template-columns: 1fr auto; gap:15px; align-items:center;">
                <div>
                    ...
                    <div style="font-size:0.9rem;">
                        ...
                        <span style="background:#444; color:#fff; padding:2px 5px; border-radius:3px; font-size:0.8rem;">${t.duracao} Rodadas</span>
                    </div>
                </div>
