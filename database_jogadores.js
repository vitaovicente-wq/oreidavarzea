...
const database = {
    brasil: {
        ...
        serieA: [
            ...
            },
            {
                ...
                elenco: [
                    ...
                    { nome: "Aranha", pos: "GOL", forca: 69, idade: 20, carac: "Reflexo" },
                    { nome: "Agustín Giay", pos: "LD", forca: 78, idade: 22, carac: "Apoio" },
                    { nome: "Khellven", pos: "LD", forca: 77, idade: 25, carac: "Cruzamento" },
                    { nome: "Mayke", pos: "LD", forca: 75, idade: 33, carac: "Velocidade" },
                    { nome: "Gustavo Gómez", pos: "ZAG", forca: 83, idade: 33, carac: "Liderança" },
                    { nome: "Murilo", pos: "ZAG", forca: 81, idade: 29, carac: "Força" },
                    { nome: "Bruno Fuchs", pos: "ZAG", forca: 77, idade: 27, carac: "Passe" },
                    { nome: "Vitor Reis", pos: "ZAG", forca: 75, idade: 20, carac: "Antecipação" },
                    { nome: "Benedetti", pos: "ZAG", forca: 71, idade: 19, carac: "Cabeceio" },
                    { nome: "Piquerez", pos: "LE", forca: 82, idade: 28, carac: "Chute de Longe" },
                    { nome: "Jefté", pos: "LE", forca: 76, idade: 22, carac: "Drible" },
                    { nome: "Vanderlan", pos: "LE", forca: 75, idade: 23, carac: "Velocidade" },
                    { nome: "Marlon Freitas", pos: "VOL", forca: 80, idade: 31, carac: "Passe Longo" },
                    { nome: "Allan", pos: "VOL", forca: 79, idade: 29, carac: "Visão" },
                    { nome: "Zé Rafael", pos: "VOL", forca: 78, idade: 33, carac: "Desarme" },
                    { nome: "Emiliano Martínez", pos: "VOL", forca: 77, idade: 27, carac: "Raça" },
                    { nome: "Fabinho", pos: "VOL", forca: 75, idade: 24, carac: "Marcação" },
                    { nome: "Raphael Veiga", pos: "MEI", forca: 84, idade: 31, carac: "Finalização" },
                    { nome: "Mauricio", pos: "MEI", forca: 80, idade: 25, carac: "Drible" },
                    { nome: "Felipe Anderson", pos: "MEI", forca: 81, idade: 33, carac: "Técnica" },
                    { nome: "Andreas Pereira", pos: "MEI", forca: 80, idade: 30, carac: "Chute Livre" },
                    { nome: "Lucas Evangelista", pos: "MEI", forca: 76, idade: 31, carac: "Dinâmica" },
                    { nome: "Rômulo", pos: "MEI", forca: 74, idade: 24, carac: "Visão" },
                    { nome: "Vitor Roque", pos: "ATA", forca: 83, idade: 21, carac: "Explosão" },
                    { nome: "Paulinho", pos: "ATA", forca: 82, idade: 26, carac: "Infiltração" },
                    { nome: "Estêvão", pos: "ATA", forca: 84, idade: 18, carac: "Velocidade" },
                    { nome: "Facundo Torres", pos: "ATA", forca: 81, idade: 26, carac: "Habilidade" },
                    { nome: "Ramón Sosa", pos: "ATA", forca: 79, idade: 27, carac: "Velocidade" },
                    { nome: "Flaco López", pos: "ATA", forca: 79, idade: 25, carac: "Cabeceio" },
                    { nome: "Bruno Rodrigues", pos: "ATA", forca: 76, idade: 29, carac: "Drible" },
                    { nome: "Luighi", pos: "ATA", forca: 73, idade: 20, carac: "Finalização" }
                ]
            },
            {
        ...
        serieB: [
            ...
            {
                id: "atleticomg", nome: "Atlético-GO", escudo: "https://a.espncdn.com/i/teamlogos/soccer/500/1044.png", forca: 72, orcamento: "R$ 70 Mi", destaque: "Luiz Fernando",
                elenco: [
